...
import com.example.csulb.wecare.databinding.ActivityRootBinding;

import java.util.Set;

//The first page to load for fitbit login
public class RootActivity extends AppCompatActivity implements AuthenticationHandler {

    private ActivityRootBinding binding;

    //on create method for rootactivity
    @Override
    ...
    //onresume method for rootactivity
    @Override
    ...
    //on logged in method for rootactivity
    ...
    //onback pressed navigating to homeactivity
    public void onBackPressed()
    {
        Intent myIntent = new Intent(RootActivity.this, HomeActivity.class);
        startActivity(myIntent);
    }

    //on login activity navigating to authentication manager class
    ...
    //on authorization of the user from authentication manager
    ...
    //if authentication has some error display error
